...
export default function SignUp() {
  ...
  return (
      <div className="flex w-full flex-col items-center justify-center">
          <div className="flex w-448 h-full flex-col items-center justify-center">

              {/* Create your account 파트*/}
              <div className="text-head-30-800 mb-8 text-3xl font-extrabold">
                Create your account
              </div>
              <div className="body-14-500 flex flex-row mb-16">
                <span className="text-gray-700">Or&ensp;</span>
                <a className="cursor-pointer text-gray-900 hover:underline">sign in to your existing account</a>
              </div>
    
              {/* 회원가입 정보 기입란 */}
              <div className="flex w-full flex-col items-center justify-center bg-white p-32 shadow-md">
    
                  <div className="flex w-full flex-row items-center justify-center gap-16 mb-16">
                ...
                {/* 약관동의 파트 */}
                <div className="flex h-24 w-full flex-row items-center justify-start mb-16">
                  <Checkbox
                    checked={enabled}
                    onChange={setEnabled}
