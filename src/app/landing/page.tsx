...
export default function Landing() {
  return (
    <div className="flex h-full w-full flex-col">
      <div className="pd-96 flex h-480 flex-col items-center justify-center bg-white pt-96">
        <div className="text-head-60-700 mb-24 text-6xl font-bold">
          Easy Shift
        </div>
        <div className="text-head-30-400 mb-28 text-3xl font-normal">
          Effortlessly Manage Your Team&apos;s Schedule
        </div>
        <div className="text-head-20-400 text-xl font-normal">
          Streamline your workforce management with our intuitive scheduling
          solution. Save
        </div>
        <div className="text-head-20-400 mb-48 text-xl font-normal">
          time, reduce errors, and keep your team synchronized.
        </div>
        <div className="flex flex-row gap-18">
          <div className="body-18-500 flex h-62 w-195 cursor-pointer items-center justify-center rounded-4 bg-black text-white">
            Get Started Free
          </div>
          <div className="body-18-500 mb-48 flex h-62 w-195 cursor-pointer items-center justify-center rounded-4 border border-gray-900 bg-white text-black">
            Learn More
          </div>
        </div>
      </div>
      <div className="flex h-372 w-full flex-row justify-evenly bg-gray-100">
        <FeatureCard
          icon={<CalendarIcon />}
